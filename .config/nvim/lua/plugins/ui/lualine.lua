...
M.config = function()
  ...
  local diff = {
    ...
    colored = true,
    symbols = {
      added = icons.lvim_git.LineAdded,
      modified = icons.lvim_git.LineModified,
      removed = icons.lvim_git.LineRemoved,
  ...
  require("lualine").setup({
    options = {
      component_separators = { left = "", right = icons.ui.DashedLine .. " " },
