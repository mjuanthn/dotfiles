vim.wo.number = false -- Make line numbers default (default: false)
...
vim.wo.signcolumn = "yes:3" -- Keep signcolumn on by default (default: 'auto')
...
--
-- Set MJML files to be interpreted as PHP
vim.filetype.add({
  extension = {
    mjml = "php",
  },
