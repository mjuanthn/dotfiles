...
-- Buffer actions
vim.keymap.set({ 'n', 'i', 'v' }, '<leader>bd', ':bdelete<CR>', { noremap = true, silent = true })

-- Keybinds to make split navigation easier.
--  Use CTRL+<hjkl> to switch between windows
--
-- Disable avpag and repag
vim.keymap.set({ 'n', 'i' }, '<PageUp>', '<Nop>', { noremap = true, silent = true })
vim.keymap.set({ 'n', 'i' }, '<PageDown>', '<Nop>', { noremap = true, silent = true })
...
vim.keymap.set({ 'n', 'v' }, '<Del>', '<Nop>', { noremap = true, silent = true })
--
-- Deshabilitar el clic derecho
vim.keymap.set({ 'n', 'i' }, '<RightMouse>', '<Nop>', { noremap = true })
...
require('lazy').setup({
  ...
  --   opts = {
  --     signs = {
  --       add = { text = icons.ui.Circle },
  --       change = { text = icons.ui.Circle },
  --       delete = { text = icons.ui.Circle },
  --       topdelete = { text = '‾' },
  --       changedelete = { text = '~' },
  --     },
  --   },
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'vue', 'html', 'scss', 'typescript' },
