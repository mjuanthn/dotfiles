return { -- LSP Configuration & Plugins
  ...
  config = function()
    ...
    local volar_typescript_server_path = '~/.local/share/nvim/mason/packages/typescript-language-server/node_modules/typescript/lib'
    ...
    local servers = {
      volar = {
        ...
        init_options = {
          ...
          typescript = {
            tsdk = volar_typescript_server_path,
          },
        },
      },
      tsserver = {
